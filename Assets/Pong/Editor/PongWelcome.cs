...
[InitializeOnLoad]
public class PongInfo : EditorWindow 
{
	private const string ASSETSTORE_URL = "http://u3d.as/AAh";
	private const string ONLINE_DOC_URL = "https://goo.gl/pekuTQ";
	private const string PATREON_URL = "https://www.patreon.com/skardgames";
	private const string FACEBOOK_URL = "https://www.facebook.com/Skard-Games-1268859439806011/";
	private const string TWITTER_URL = "https://twitter.com/skardgame"; 
	private const string CONTACT_URL = "https://goo.gl/G6EWYt"; 
	...
	[MenuItem("Assets/Pong Info", false, 0)]
	public static void OpenWelcomeWindow(){
		GetWindow<PongInfo>(true);
	}
	...
	void OnEnable(){
		...
		titleContent = new GUIContent("                                                               Welcome To Pong"); 
		#endif
	...
	public void OnGUI(){
		...
		if (Button(rateIcon,"Rate this asset","Write us a review on the asset store.")){
			Application.OpenURL(ASSETSTORE_URL);
		}
